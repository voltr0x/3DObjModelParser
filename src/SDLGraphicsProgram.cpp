...
SDLGraphicsProgram::SDLGraphicsProgram(int w, int h):m_screenWidth(w),m_screenHeight(h){
  ...
  //       Object* temp = new Object;
		// temp->MakeTexturedQuad("Zombie.obj");
...
void SDLGraphicsProgram::LoadOBJ(std::string fileName) {
    Object* temp = new Object;
    temp->MakeTexturedQuad(fileName);
    ObjectManager::Instance().AddObject(temp);
}
...
void SDLGraphicsProgram::Update(){
    ...
    ObjectManager::Instance().GetObject(0).GetTransform().Translate(0.0f,0.0f,-9.0f);
    ObjectManager::Instance().GetObject(0).GetTransform().Rotate(glm::radians(rot),0.0f,1.0f,0.0f);
